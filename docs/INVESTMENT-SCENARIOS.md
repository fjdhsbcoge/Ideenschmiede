# Ideenschmiede Investment Scenarios

## Model Parameters

| Parameter | Value | Notes |
|-----------|-------|-------|
| **Ideator immediate cut** | 15% | Of outside investment (compensation for ideation) |
| **Chain-of-thought pool** | 5% | Distributed to early contributors |
| **Team funding** | 80% | Investor chooses which team |
...
### 1. Break-Even Point (15% model)
Ideator breaks even when outside investment = 6.67x their initial investment
- Because 15% of outside = their initial 100%
- Example: Invest ₿ 0.01 → Need ₿ 0.067 outside → Get ₿ 0.01 back (15% of ₿ 0.067)

### 2. Profit Multiplier
To make **2x** your investment back immediately:
- Need **13.33x** outside investment
- Example: Invest ₿ 0.01 → ₿ 0.133 outside → Get ₿ 0.02 back

To make **10x** your investment back immediately:
- Need **66.67x** outside investment
- Example: Invest ₿ 0.01 → ₿ 0.667 outside → Get ₿ 0.10 back

### 3. The Real Upside: Idea-Shares

With **1% ownership** and **50% revenue share** from teams:

| Scenario | B2 (Medium) | C2 (High) |
|----------|-------------|-----------|
| Ideator invests | ₿ 0.10 | ₿ 1.0 |
| Team funding | ₿ 0.533 | ₿ 5.33 |
| If team generates 10x revenue | ₿ 5.33 | ₿ 53.3 |
| Idea-share pool (50%) | ₿ 2.67 | ₿ 26.65 |
| **Ideator's 1% share** | ₿ 0.027 | ₿ 0.267 |
| Plus immediate 15% | ₿ 0.10 | ₿ 1.0 |
| **Total return** | ₿ 0.127 (1.27x) | ₿ 1.267 (1.27x) |

**Key insight:** Even with just 1% ownership, the 50% revenue split creates meaningful upside if teams succeed.

### 4. What if Ideator Owns 5%?

| Scenario | B2-1% | B2-5% |
|----------|-------|-------|
| Ideator investment | ₿ 0.10 | ₿ 0.10 |
| Valuation | ₿ 10.0 | ₿ 2.0 |
| Shares owned | 1M (1%) | 5M (5%) |
| Break-even outside | ₿ 0.667 | ₿ 0.667 |
| **Future value (10x revenue)** | | |
| → Idea-share pool | ₿ 2.67 | ₿ 2.67 |
| → Ideator's share | ₿ 0.027 | ₿ 0.133 |
| → **Total return** | ₿ 0.127 | ₿ 0.233 |
| **ROI** | 1.27x | 2.33x |

**Trade-off:** Lower valuation = easier to fund, higher % = more upside.
...
*Generated for Ideenschmiede V0 discussion*
